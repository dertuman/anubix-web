export default {
  ...
  footer: {
    companyDescription: 'A coding agent in the cloud. Build from any device.',
    product: 'Product',
    pricing: 'Pricing',
    about: 'About',
    legal: 'Legal',
  ...
  home: {
    hero: {
      ...
      subtitle:
        'Anubix is a full coding agent in the cloud. Describe what you want, watch it build in real time, and iterate from any device.',
      cta: 'Start building',
      ctaSecondary: 'Explore the AI chat',
      trustLine: 'No credit card needed. No lock-in. You own your code.',
      stat1: 'AI-powered coding agent',
      stat2: 'Phone, tablet, or laptop',
      stat3: 'Cloud-based workspace',
    },
    screenshots: {
    ...
    mobileHook: {
      ...
      body2:
        'Anubix runs your entire workspace in the cloud. The agent, the file system, the terminal, the preview: all accessible from your phone, tablet, or laptop. Start a project on the train. Review it at lunch. Ship from your couch.',
      body3:
    ...
    multiModel: {
      ...
      body: 'Connect your existing API keys and use the models you already pay for.',
      claude: {
        title: 'Claude',
      ...
      switchNote: 'Bring your own API keys to use supported models through a single interface.',
      oneliner: 'One interface for the AI models you already use.',
    },
    differentiator: {
      label: 'Under the hood',
      title: 'A real coding agent. Not an API wrapper.',
      body: "Most AI builders send your prompt to an API and paste the response into a file. That works for simple projects, but it breaks the moment you need real complexity.",
      body2:
        'Anubix runs a full coding agent in a cloud VPS with a real file system, multi-file awareness, terminal access, dependency management, and debugging. The same environment a developer uses locally, accessible from anywhere.',
    ...
    pricing: {
      ...
      subtitle: "No subscriptions. No commitments.",
      free: {
        name: 'Free',
        tagline: 'Get started instantly.',
        feature1: 'Try the platform at no cost',
        feature2: 'Access the coding agent',
        feature3: 'Cloud-based workspace',
        feature4: 'No credit card required',
        cta: 'Start building',
      },
      byok: {
        name: 'Bring your own key',
        tagline: 'Use the AI models you already pay for.',
    ...
    faq: {
      ...
      a2: "Bolt and Lovable are great for simple projects. Anubix runs a real cloud dev environment that handles complex, multi-file applications. Plus: you can build from your phone and bring your own API keys.",
    ...
    cta: {
      ...
      subtitle: 'Build from any device. Powered by AI.',
