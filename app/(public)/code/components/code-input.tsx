        ...
        <div className="relative mx-auto">
          ...
          <div className="flex items-end gap-2">
            ...
            <div className="flex shrink-0 items-center gap-1.5">
              {isBusy && (
                <Button variant="destructive" size="icon" onClick={onStop} className="size-11 rounded-xl sm:size-12" title="Stop (Esc)">
              ...
              {canSend && (
                <Button size="icon" onClick={handleSend} disabled={disabled} className="size-11 rounded-xl ring-1 ring-primary/20 sm:size-12" title={isBusy ? 'Queue message' : 'Send message'}>
                  <ArrowUp className="size-5" />
                </Button>
              )}
            </div>
