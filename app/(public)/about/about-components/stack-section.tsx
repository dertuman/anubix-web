...
const STACK_ICONS: Record<string, React.FC<{ className?: string }>> = {
  nextjs: NextjsIcon,
  clerk: ClerkIcon,
...
export function StackSection() {
  const t = useScopedI18n('about.stack');
            ...
            return (
              ...
              >
                ...
                <h3 className="text-base font-semibold text-foreground">
                  {t(`${key}.title` as 'nextjs.title')}
                </h3>
                <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                  {t(`${key}.description` as 'nextjs.description')}
                </p>
              </div>
            );
          })}
...
function ClaudeIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M4.709 15.955l4.397-2.028a.273.273 0 0 1 .222-.002l.156.07a.273.273 0 0 0 .222-.002l6.262-2.89a.273.273 0 0 0 .158-.247V9.843a.273.273 0 0 0-.378-.252l-3.46 1.474a.273.273 0 0 1-.222-.002l-3.292-1.558a.273.273 0 0 1-.156-.247v-.818a.273.273 0 0 1 .378-.252l3.178 1.354a.273.273 0 0 0 .222-.002l4.896-2.259a.273.273 0 0 0 .158-.247V5.5a.273.273 0 0 0-.158-.247L12.168 3.01a.273.273 0 0 0-.222-.002L4.551 6.52a.273.273 0 0 0-.158.247V16.2a.273.273 0 0 0 .316.268zm7.459 5.036l7.395-3.413a.273.273 0 0 0 .158-.247v-1.736a.273.273 0 0 0-.378-.252l-7.175 3.056a.273.273 0 0 1-.222-.002l-3.293-1.558a.273.273 0 0 1-.155-.247v-.818a.273.273 0 0 1 .377-.252l3.179 1.354a.273.273 0 0 0 .222-.002l7.267-3.353a.273.273 0 0 0 .158-.247v-1.283a.273.273 0 0 0-.158-.247l-7.395-3.502a.273.273 0 0 0-.222-.002l-7.395 3.413a.273.273 0 0 0-.158.247v9.555a.273.273 0 0 0 .158.247l7.395 3.502a.273.273 0 0 0 .222-.002z" />
    </svg>
  );
}
